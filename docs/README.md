...
Member-facing journey and Core API notes for the Eijent landing / web app team.
...
Keep these in sync when APIs change:

- `bps-core/docs/architecture/plans-credits-coupons.md`
- `bps-core/docs/api/credits-coupons-entitlements.md`
